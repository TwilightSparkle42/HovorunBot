...
from ai_client.infermatic import InfermaticAiClient
...
class BotRuntime:
    def __init__(
        ...
        self._application = (
            Application.builder().token(self._settings.telegram_token).build()
        )
    ...
    def add_handlers(self) -> None:
        ...
        self._application.add_handler(
            CommandHandler("known_models", self.known_models_command)
        )
